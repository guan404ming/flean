...
/-- Generic cast with explicit tininess-detection mode. -/
noncomputable def FloatBits.castWithTininess {srcSpec dstSpec : BinarySpec}
  ...
  | .zero | .normal | .subnormal =>
    ...
    let flags := {
      ...
      underflow := underflowFlagWithTininess dstSpec.toFormat tininess exact rounded
    }
